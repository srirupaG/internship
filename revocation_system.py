...
def verify_credential(vc):
    ...
    if "credentialStatus" in vc:
        ...
        revocation_bitmap = BitMap.deserialize(
            zlib.decompress(base64.b64decode(issuer_revocation_list["serviceEndpoint"].rsplit(",")[1])))
...
def test_for_valid_credential(signed_credential):
    ...
    if is_revoked:
        ...
        print("revocation_list is :::", revocation_list)
    else:
...
if __name__ == "__main__":
    ...
    print("############# Test to see if credential is revoked ###################")
